...
public class IssuerTests
{
    ...
    public void CanIssueCredential()
    {
        ...
        var issuer = new SD_JWT.Roles.Implementation.Issuer();
    ...
    public void CanTraverseJson()
    {
        ...
        SD_JWT.Roles.Implementation.Issuer.FindAndReplaceSdProperties(payload, "$", ref sdPaths, ref counter, disclosures);
