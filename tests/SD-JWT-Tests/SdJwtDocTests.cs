...
public class SdJwtDocTests
{
    ...
    private const string anotherExample = """
    ...
    [Test]
    public void CanParseAnotherExample(string input)
    {
        var doc = new SdJwtDoc(input);
        
        Assert.That(doc.UnsecuredPayload, Is.Not.Null);
    }
}